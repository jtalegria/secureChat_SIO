    ...
    public static void registar() throws IOException, NoSuchAlgorithmException {
        ...
        if (registerLimit == 1) {
            ...
            //        } 
                ...
                System.out.println(">> Cliente jÃ¡ registado. Considere outro nome.");
                System.out.println("");
            }
            registerLimit++;
        }
        else{
            System.out.println("FunÃ§Ã£o registar apenas disponivel 1 vez");
        }
    }
...
//        }
    ...
    public static void sendSimetricCipher() throws NoSuchAlgorithmException, NoSuchPaddingException, 
        ...
        byte[] textoCifradoArray = cypherMsg(msgToByteArray, sk);
    ...
    public static byte[] cypherMsg(byte[] cm, SecretKey sk) throws NoSuchAlgorithmException, 
            NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException{
